...
class WebHDFSHook(BaseHook):
    ...
    def __init__(
        self, webhdfs_conn_id: str = "webhdfs_default", proxy_user: Optional[str] = None
    ):
        super().__init__()
    ...
    def _get_client(self, namenode: str, port: int, login: str, extra_dejson: dict):
    ...
    def check_for_path(self, hdfs_path: str):
        """
